...
public final class GridItemBinding implements ViewBinding {
  ...
  private GridItemBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
  ...
  public static GridItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GridItemBinding((ConstraintLayout) rootView, cardView, productImage,
