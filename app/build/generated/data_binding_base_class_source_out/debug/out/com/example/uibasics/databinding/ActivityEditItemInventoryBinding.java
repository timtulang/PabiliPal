...
public final class ActivityEditItemInventoryBinding implements ViewBinding {
  ...
  private ActivityEditItemInventoryBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull ImageButton imageButton5, @NonNull ImageButton incrementStock,
      @NonNull TextView labelProdDesc, @NonNull TextView labelProdName,
      @NonNull TextView labelProdPrice, @NonNull TextView labelProdStock,
      @NonNull RelativeLayout main, @NonNull EditText productDesc, @NonNull EditText productName,
  ...
  public static ActivityEditItemInventoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditItemInventoryBinding((RelativeLayout) rootView, addImage, addStock,
          addtoInventory, decrementStock, deleteItem, imageButton5, incrementStock, labelProdDesc,
