...
public final class ActivityAddItemToCartBinding implements ViewBinding {
  ...
  private ActivityAddItemToCartBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView labelProdStock, @NonNull RelativeLayout main, @NonNull TextView productDesc,
  ...
  public static ActivityAddItemToCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddItemToCartBinding((RelativeLayout) rootView, addImage, addStock,
          addtoCart, decrementStock, imageButton6, incrementStock, labelProdDesc, labelProdName,
          labelProdPrice, labelProdStock, main, productDesc, productName, productPrice);
    }
