...
import com.example.uibasics.BR;
import androidx.annotation.NonNull;
import androidx.annotation.Nullable;
import android.view.View;
@SuppressWarnings("unchecked")
public class ActivitySignUpUserBindingImpl extends ActivitySignUpUserBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.create_user_label, 1);
        sViewsWithIds.put(R.id.signup_user, 2);
